...
from train_MFISNet_Parallel import (
    main as train_mfisnet_parallel_main,
    load_data,
    setup_args,
)

from src.models.MFISNet_Parallel import load_MFISNet_Parallel_from_state_dict
...
class Test_load_data:
    def test_0(self) -> None:
        ...
        arrays saved in the MultiFreqData object have the expected
        ...
        check_arrays_close(data.q_polar.numpy(), data_2.q_polar.numpy())
    ...
    def test_1(self) -> None:
        ...
        assert np.allclose(data.q_polar.numpy(), data_2.q_polar.numpy())


class Test_train_mfisnet_parallel_main:
...
"""
        ...
        train_mfisnet_parallel_main(args)

        expected_n_epochs = n_epochs
        ...
        model = load_MFISNet_Parallel_from_state_dict(state_dict)
