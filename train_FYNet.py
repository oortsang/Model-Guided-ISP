...
train_MFISNet_Fused.py (a single-frequency MFISNet_Fused run is
equivalent to FYNet).
"""
import logging

from train_MFISNet_Fused import setup_args, main
